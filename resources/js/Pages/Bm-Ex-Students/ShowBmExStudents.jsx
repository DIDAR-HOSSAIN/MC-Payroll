        ...
        <AdminDashboardLayout
            ...
            header={
                <h2 className="text-2xl font-semibold text-center md:text-left">
                    BM Ex-Student Details
                </h2>
            }
        >
            <Head title="BM Ex-Student Details" />
            <div className="max-w-7xl mx-auto p-6 bg-white rounded-lg shadow-lg">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
                    <div className="flex flex-col">
                        ...
                        <span className="text-lg">{member.member_id}</span>
                    </div>
                    <div className="flex flex-col">
                        <label className="font-medium text-sm text-gray-600">
                            Father's Name
                    ...
                    <div className="flex flex-col">
                        ...
                        <span className="text-lg">{formatDate(member.date_of_birth)}</span>
                    </div>
                    <div className="flex flex-col">
                        <label className="font-medium text-sm text-gray-600">
                            Gender
                    ...
                    <div className="flex flex-col">
                        ...
                        <span className="text-lg">{formatDate(member.reg_date)}</span>
                    </div>
                    <div className="flex flex-col">
                        <label className="font-medium text-sm text-gray-600">
                            Approval Date
                        </label>
                        <span className="text-lg">{formatDate(member.approval_date)}</span>
                    </div>
                    <div className="flex flex-col">
                        <label className="font-medium text-sm text-gray-600">
                            Dakhil Year
                    ...
                    <div className="flex flex-col">
                        ...
                        <span className="text-lg">{member.membership_fee}</span>
                    </div>
                    <div className="flex flex-col">
                        <label className="font-medium text-sm text-gray-600">
                            Transaction No
